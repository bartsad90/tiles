...
- [x] change the end round button text to 'count score'

- [ ] add icons for bonus points categories

- [ ] simulate negTiles outcome when hovering on pickedRows

- [ ] changeable player names

- [x] add negative points symbols **#CSS**
